-- Smart Parking & Vehicle Tracking System Schema (PostgreSQL)
-- Central, normalized, DB-focused design (80% of project weight)
...
CREATE TABLE transactions (
    ...
    duration_minutes INT GENERATED ALWAYS AS (
        CASE WHEN check_out_time IS NOT NULL THEN (EXTRACT(EPOCH FROM (check_out_time - check_in_time)) / 60)::INT END
    ) STORED,
